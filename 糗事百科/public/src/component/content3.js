		...
		return (
			<div className="home-one" style={{background:this.props.background}}>
				<div>
					...
					<p><a href="javascript:void(0)" className="home-content">每天骑车去驾校，路上风吹的头发一秒一个发型，遂买了个帽子，哥哥不哥，室友看到了，跟另一个室友说，这是xxx买的装b帽，然后他就戴头上了</a></p>
					<p><span>111</span>好笑 · <span>2</span>评论 · 发表于<a href="javascript:void(0)" className="showtime">2014-05-13</a></p>
					{this.props.children}
				</div>
			</div>
		)
