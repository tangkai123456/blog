...
export default class CtrlContent extends React.Component {
	render() {
		return (
			<div>
				<div className="ctrl-home">
					<Content2/>
				</div>
				<div className="ctrl-qiushi">
					<Content3/>
				</div>
				<div className="ctrl-comment hidden-xs">
						...
						<div className="comment-right">
							...
							<Content3 background="#f7f7f7" isQuote="true">
								<div className="other-opinion">
									<a href="#" className="hoverColor">光光光棍</a> , <a href="#" className="hoverColor">大胡子很性感！</a>,和另外 <span>87</span> 人评论了这条糗事
								</div>
							</Content3>
						</div>
					</div>
				...
				<div className="ctrl-settings">
					...
					<Tip cName="hidden-xs">
						...
						<ul>
							<li className="bindOther">
								<a href="#">绑定微信账号</a><a href="#" className="hoverColor">解绑</a>
							</li>
							<li className="bindOther">
								<a href="#">绑定微博账号</a><a href="#" className="hoverColor">解绑</a>
							</li>
							<li className="bindOther">
								<a href="#">绑定QQ账号</a><a href="#" className="hoverColor">解绑</a>
							</li>
							<li className="bindOther">
								<a href="#">绑定邮箱</a><a href="#" className="hoverColor">解绑</a>
							</li>
						</ul>
					</Tip>
					<Tip cName="hidden-xs">
					...
					<Tip cName="hidden-xs">
						...
						<div><a href="#" className="hoverColor">确认关闭</a></div>
					</Tip>
					<Tip cName="hidden-xs">
						<h3>帐号</h3>
						<div><a href="#" className="hoverColor">退出登录</a></div>
					</Tip>
